...
// ======
// THINGS TO DO *EDIT* ROUTE
// ======
// This is the edit route, it uses the id so it goes underneath the original id route
...
// ===========
// THINGS TO DO *PUT* ROUTE
// ===========
// EXAMPLE PUT ROUTE USING METHOD-OVERRIDE - TESTER
// ==========
// router.put('/thingstodo/:id', async(req, res) => {
// 	res.send("IT WORKED!!")
// });
...
module.exports.editThingToDo = async (req, res) => {
	// useful destructuring
	const { id } = req.params;
	// using the grouping by thingstodo (under 'name' in ejs on inputs)
	// notice we are also spreading an object into an object
	// Also notice we are using the same variable name our object is under when we looked at the body
